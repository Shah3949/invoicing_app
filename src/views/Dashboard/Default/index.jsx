        ...
        <Grid container spacing={gridSpacing}>
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              ...
              icon={FaFileInvoice} // <-- make sure this is imported and not undefined
              primary="$30200"
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              label="Invoices"
              icon={FaClipboardList} // <-- make sure this is imported and not undefined
              primary="145"
              secondary="Task"
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              label="Products"
              icon={FaBoxOpen} // <-- make sure this is imported and not undefined
              primary="290+"
          ...
          <Grid item lg={3} sm={6} xs={12}>
            <ReportCard
              label="Clients"
              icon={FaUsers} // <-- make sure this is imported and not undefined
              primary="500"
              secondary="Downloads"
